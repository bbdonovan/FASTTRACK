...
2. The backend code uses the inputs to search for related articles from selected news api sources. --Note: The api calls are coded in newsdata_io.py and newsapi_org.py, which require python packages newsdataapi and newsapi-python, respectively.
