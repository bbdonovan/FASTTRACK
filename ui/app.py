...
# --- Make graphrag package importable
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
GRAPHRAG_DIR = os.path.join(BASE_DIR, "graphrag")
if GRAPHRAG_DIR not in sys.path:
    sys.path.insert(0, GRAPHRAG_DIR)

from load_data import run_graphrag_pipeline
...
if not API_KEY:
    #TODO: consider changing this from a hard-crash to a warning, as Gemini may not be used in GraphRAG
    """
    print("\n" + "="*50)
